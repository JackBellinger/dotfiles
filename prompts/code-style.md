...
- When I ask you to help me with design, use the question-and-answer format from `docs/design/v1/design-questions.md`.
- When I ask you to create a new workflow, use the format from the files in `example_workflows/`.

### Code Generation

- When I ask you to write code, first understand the requirements and ask clarifying questions.
- Once the requirements are clear, generate the code and explain how it works.
- If the code is complex, also generate unit tests.

### File Manipulation

- When I ask you to create a new file, ask me for the path and content.
- When I ask you to modify an existing file, ask me for the path and the changes to be made.
